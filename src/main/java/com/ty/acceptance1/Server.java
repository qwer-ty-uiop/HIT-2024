...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 模拟需要发送的数据包
        String[] DATA_PACKETS = {"data1", "data2", "data3", "data4", "data5", "data6", "data7", "data8", "data9", "data10", "data11", "data12", "data13", "data14", "data15", "data16"};

        while (base < DATA_PACKETS.length) {
            // 尽可能发送packet
